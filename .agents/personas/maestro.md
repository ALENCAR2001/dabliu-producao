...
1b. **Agent Skills.** Follow `skills/addy-agent-skills.md`. When dispatching implementation, review, or spec work, instruct sub-agents to read the matching `vendor/agent-skills/skills/<name>/SKILL.md` before acting.
